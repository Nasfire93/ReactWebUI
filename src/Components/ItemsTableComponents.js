  ...
  const bodyInsert = (
    <div className={styles.modal}>
      ...
      <Autocomplete
        multiple
        getOptionSelected={(option, value) =>
          option.priceReductionId === value.priceReductionId
        }
  ...
  return (
    <div>
      ...
      <Grid
        ...
        alignItems="flex-start"
      >
        <Button size="large" variant="outlined" onClick={changeModalInsert}>
          Add new item
        </Button>
      ...
      />
      <Modal open={modalInsert} onClose={changeModalInsert}>
        {bodyInsert}
      </Modal>

      <Modal open={modalEdit} onClose={changeModalEdit}>
        <EditItemComponent
          data={dataedit}
